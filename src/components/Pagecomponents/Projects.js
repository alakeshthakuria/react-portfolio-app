...
function Projects() {
  ...
  return (
    <div  className="projects-container">
      ...
      <p className="projects-content">Overview:<br />
Developed a dynamic and responsive full-stack web application using React for the frontend and Node.js for the backend. Leveraged AWS EC2 for hosting the application and utilized Docker for streamlined production deployment. The project showcases proficiency in web development, cloud computing, and containerization. <br /></p>
    <p className="projects-content">Technologies Used: <br /><strong>Frontend:</strong>React <br /><strong>Backend:</strong>Node.js<br /><strong>Deployment:</strong> AWS EC2<br /> <strong>Containerization:</strong> Docker<br /><strong>Version Control:</strong> GitHub<br /></p>
<p className="projects-content">Key Features:<br />
...
5. <strong>GitHub for Version Control:</strong><br />Utilized GitHub for version control, enabling collaborative development and easy tracking of code changes.<br /></p>
<p className="projects-content">Deployment Process:<br />
...
5. <strong>Continuous Integration/Continuous Deployment (CI/CD):</strong><br />Set up CI/CD pipelines for automated testing and deployment, streamlining the development lifecycle.<br /></p>
<p className="projects-content">Outcome:<br />
...
This project is a testament to my commitment to best practices in web development and my ability to leverage cutting-edge technologies to deliver high-quality solutions.<br /></p>
    <button button className="about-me-button" onClick={handleButtonClick}>Go to AboutMe</button>
    </div>
    </div>
  );
}
